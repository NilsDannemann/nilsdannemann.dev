...
<div class="wrap">
    ...
    <p><?php esc_html_e('StoryChief eliminates time waisting. To set up StoryChief, enter you encryption key given to you by StoryChief.',
            'storychief'); ?></p>
                    ...
                    <tr>
                        ...
                        <td>
                            <input id="key" name="key" type="password" size="15" value="<?php echo $encryption_key; ?>"
                                   class="regular-text">
                            <p class="description"><?php esc_html_e('Your encryption key is given when you add a WordPress destination on StoryChief',
                                    'storychief'); ?></p>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            ...
                            <p class="description"><?php esc_html_e('Save this in your StoryChief Configuration',
                                    'storychief'); ?></p>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" name="test_mode"
                                   value="1" <?php echo ($test_mode == 1) ? 'checked' : '' ?>> Enable test mode<br>
                            <p class="description"><?php esc_html_e('Keep your articles as draft. This means you won\'t be able to publish multichannel as long as it\'s on',
                                    'storychief'); ?></p>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="checkbox" name="author_create"
                                   value="1" <?php echo ($author_create == 1) ? 'checked' : '' ?>> Enable creation of
                            unknown authors<br>
                            <p class="description"><?php esc_html_e('This option allows you to automatically create new authors in WordPress when needed.',
                                    'storychief'); ?></p>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row"><label
                                    for="category_create"><?php esc_html_e('Create unknown categories',
                                    'storychief'); ?></label></th>
                        <td>
                            <input type="checkbox" name="category_create"
                                   value="1" <?php echo ($category_create == 1) ? 'checked' : '' ?>> Enable creation of
                            unknown categories<br>
                            <p class="description"><?php esc_html_e('This option allows you to automatically create new categories in WordPress when needed.',
                                    'storychief'); ?></p>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row"><label
                                    for="tag_create"><?php esc_html_e('Create unknown tags', 'storychief'); ?></label>
                        </th>
                        <td>
                            <input type="checkbox" name="tag_create"
                                   value="1" <?php echo ($tag_create == 1) ? 'checked' : '' ?>> Enable creation of
                            unknown
                            tags<br>
                            <p class="description"><?php esc_html_e('This option allows you to automatically create new tags in WordPress when needed.',
                                    'storychief'); ?></p>
                        </td>
                    </tr>
                    <tr>
                        <th scope="row"><label
                                    for="sideload_images"><?php esc_html_e('Side-load images', 'storychief'); ?></label>
                        </th>
                        <td>
                            <input type="checkbox" name="sideload_images"
                                   value="1" <?php echo ($sideload_images == 1) ? 'checked' : '' ?>> Enable side-loading
                            of
                            images<br>
                            <p class="description"><?php esc_html_e('All images inside an article will be downloaded to your WordPress installation.',
                                    'storychief'); ?></p>
                        </td>
                    </tr>
                </tbody>
