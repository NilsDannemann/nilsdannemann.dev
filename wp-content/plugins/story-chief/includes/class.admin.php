...
class Admin {
	...
	public static function display_configuration_page() {
		...
		$wp_url = get_site_url();
        self::view('config', compact('encryption_key', 'wp_url', 'test_mode', 'author_create', 'category_create', 'tag_create', 'sideload_images', 'styling_caption', 'styling_video', 'styling_align'));
	}
